...
```{r}
load("data/title_basics_sample.rda")
title_basics <- data_table
load("data/title_ratings_sample.rda")
title_ratings <- data_table
load("data/title_principals_sample.rda")
title_principals <- data_table
load("data/name_basics_sample.rda")
name_basics <- data_table
```
